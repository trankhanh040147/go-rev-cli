...
## New Issues:
- [ ] `~/.config/revcli/presets/` : Do not have custom presets, user can't edit custom presets
- [ ] Missing feature let user edit preset (v0.3) in command line or edit file manually 
- [ ] Missing feature let user open folder preset 
## New Features 
- [ ] preset cp 
- [ ] Interactive preset management:
	- [ ] `preset manage` : Open a panel which users can CRUD interactively (Is it possible ?) --> Later releases