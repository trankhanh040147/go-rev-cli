...
- [ ] IS06: No helper found when run `rv review -h`
- [ ] IS07: Flag is too long, not great for typing (Need to be verified)
...
- [ ] **FT06:** Auto create custom presets as files, allow user to treat them like a custom presets (remove the definition of built-in preset) 